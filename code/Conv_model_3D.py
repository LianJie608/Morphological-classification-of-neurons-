...
#         self.conv3 = self._conv_layer_set(64, 128)
#
#         self.conv4 = self._conv_layer_set(128, 256)
#         self.conv5 = self._conv_layer_set(256,256)
#         self.residual2 = ResidualBlock(256, 256)
#
#         self.fc1 = nn.Linear(256, 128)
...
#         self.conv5 = self._conv_layer_set(128, 128)
#
...
#
#         self.conv4 = self._conv_layer_set(256, 256)
#         self.conv5 = self._conv_layer_set(256, 512)
#
...
#
#         self.conv4 = self._conv_layer_set(512, 512)
#         self.conv5 = self._conv_layer_set(512, 1024)
#
...
#         self.conv3 = self._conv_layer_set(32,64)
#
#         self.conv4 = DepthwiseSeparableConv3D(64, 128, kernel_size=(3, 3, 3), padding=1)
#         self.conv5 = DepthwiseSeparableConv3D(128, 256, kernel_size=(3, 3, 3), padding=1)
#
#         self.conv6 = self._conv_layer_set(256, 512)
...
#         # self.DAM = DAM(1024)
#         # self.conv7 = DepthwiseSeparableConv3D(1024, 1024, kernel_size=(3, 3, 3), padding=1)
...
#         self.conv5 = self._conv_layer_set_1(256, 256)
